    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form name="blogBannerForm" id="blogBannerForm" @if(empty($blogBanner['id'])) action="{{ url('admin/add-edit-blogBanner') }}"
                      @else action="{{ url('admin/add-edit-blogBanner/'.$blogBanner['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">სიახლეების ბანერები</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" @if(!empty($blogBanner['title']))
                                        value="{{ $blogBanner['title'] }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="3" placeholder="აღწერა" id="description" name="description">
                                                    @if(!empty($blogBanner['description'])) {{ $blogBanner['description'] }}
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if(!empty($blogBanner['image']))
                                            <div>
                                                <img src="{{ asset('images/blogBanner_images/'.$blogBanner['image']) }}" style="width: 150px;" alt="">
                                                &nbsp;
                                                <a href="javascript:void(0)" class="confirdDelete" record="blogBanner-image" recordid="{{ $blogBanner['id'] }}">
                                                    წაშლა
                                                </a>
                                            </div>
                                        @endif
